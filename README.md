...
这个项目研究 A 股在特定时段出现的拉升与回落现象，主要关注上午 10:30 附近和下午 14:00 前的价格走势。我们用分钟行情比较这些时段与其他时段的差异，再结合前后几个交易日的走势查看具体案例。
...
Zixin Huang（黄子欣）。感谢史一诺、韩鎔旭、张钰浛在课程项目中的协作。成员分工见 [AUTHORS.md](AUTHORS.md)。
